...
namespace CodeProject.AccountManagement.Data.EntityFramework
{
	...
	{
		private AccountManagementDatabase _context;
		...
		/// Database Context
		/// </summary>
		public AccountManagementDatabase dbConnection
		{
			get { return _context; }
		}
		/// <summary>
		...
		{
			_context = new AccountManagementDatabase();
			return _context;
		}

		public void OpenConnection(Object dbConnection)
		{
			_context = (AccountManagementDatabase)dbConnection;
		}
		...
		{
			_context = new AccountManagementDatabase(connectionString);
		}

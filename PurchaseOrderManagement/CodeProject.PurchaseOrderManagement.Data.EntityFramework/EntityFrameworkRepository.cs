...
namespace CodeProject.PurchaseOrderManagement.Data.EntityFramework
{
	...
	{
		private PurchaseOrderManagementDatabase _context;
		...
		/// Database Context
		/// </summary>
		public PurchaseOrderManagementDatabase dbConnection
		{
			get { return _context; }
		}
		/// <summary>
		...
		{
			_context = new PurchaseOrderManagementDatabase();
			return _context;
		}

		public void OpenConnection(string connectionString)
		{
			_context = new PurchaseOrderManagementDatabase(connectionString);
		}

		public void OpenConnection(Object dbConnection)
		{
			_context = (PurchaseOrderManagementDatabase)dbConnection;
		}
		/// <summary>
		/// Begin Transaction
		/// </summary>
